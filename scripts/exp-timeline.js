 ...
 * 
 * TODO:
 * 1. Pilot with all the problems and see how long it takes on average to change
 *    the consent form + calculate the participant pay
 */
...
$(document).ready(function() {
  ...
  console.log(student_timeline.length);
